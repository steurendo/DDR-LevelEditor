	...
	implements MouseListener, AdjustmentListener
{
	...
	private Point getRelativePoint(Point point) { return getRelativePoint(point, 0); }
	private Point getRelativePoint(Point point, int startX) { return new Point((point.x + startX) / 32, point.y / 32); }
}