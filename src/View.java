...
public class View extends JFrame
{
	...
	private ControllerDrawings controllerDrawings;
	private ControllerSettings controllerSettings;
	private JMenuBar menuBar;
	private JMenu menuProject;
	private JMenu menuCurrentLevel;
	private JMenu subMenuNew;
	private JMenuItem menuItemEmpty;
	private JMenuItem menuItemBase;
	private JMenuItem menuItemOpen;
	private JMenuItem menuItemSave;
	private JMenuItem menuItemExportData;
	private JMenuItem menuItemImport;
	private JMenuItem menuItemExport;
	private CustomTreeView treeLevels;
	private JScrollPane scrollPaneLevels;
	private JPanel panelSettings;
	private JPicture pictureLevel;
	private JPicture pictureSelectedTile1;
	private JPicture pictureSelectedTile2;
	private JPicture pictureTilemap;
	private JScrollBar scrollLevel;
	private JLabel labelSelectedTiles;
	private JLabel labelCurrentLevel;
	private JLabel labelWidth;
	private JLabel labelLinkWarpzone;
	private JLabel labelSpawnpointMode;
	private JCheckBox checkboxSpawnpointMode;
	private Button buttonSet;
	private Button buttonAdd;
	private Button buttonRemove;
	private Button buttonRemoveCurrent;
	private JTextField textWidth;
	private CustomComboBox comboLinkedWarpzone;
	...
	public int getModelState() { return model.getState(); }
	public void update()
	{
		buildTreeView();
		adjustSettings();
	...
	public void addLevelImage() { imageLevels.add(null); }
	public void removeLevelImage(int index) { imageLevels.remove(index); }
	public void removeLevelImage() { removeLevelImage(imageLevels.size() - 1); }
	public void addWarpzoneImage() { imageWarpzones.add(null); }
	public void removeWarpzoneImage(int index) { imageWarpzones.remove(index); }
	public void removeWarpzoneImage() { imageWarpzones.remove(imageWarpzones.size() - 1); }
